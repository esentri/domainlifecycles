 ...
 * the {@link nitrox.dlc.domain.types.internal.DomainObject} to its database representation (record)
 ...
 * reflected back into the passed {@link nitrox.dlc.domain.types.internal.DomainObject}.
 *
 * @param <BASE_RECORD_TYPE> the type of the record that is used to persist the {@link nitrox.dlc.domain.types.internal.DomainObject}
 *
 * @author Mario Herb
 */
public interface Persister<BASE_RECORD_TYPE> {
    ...
    /**
     * Inserts a new record for the given {@link nitrox.dlc.domain.types.internal.DomainObject} into the database.
     *
    ...
    /**
     * Updates the record for the given {@link nitrox.dlc.domain.types.internal.DomainObject} in the database.
     *
    ...
    /**
     * Deletes the record for the given {@link nitrox.dlc.domain.types.internal.DomainObject} from the database.
     *
    ...
    /**
     * Increases the version of the given {@link nitrox.dlc.domain.types.internal.DomainObject} in the database.
     *
