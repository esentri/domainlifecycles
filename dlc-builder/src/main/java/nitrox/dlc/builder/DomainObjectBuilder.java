...
public interface DomainObjectBuilder<T extends DomainObject> {
     ...
     *
     * @throws nitrox.dlc.builder.exception.DLCBuilderException if the field does not hold a Collection
     *
     * @param object added
     ...
     *
     * @throws nitrox.dlc.builder.exception.DLCBuilderException if the field does not hold a Collection or if providing the value fails
     *
     * @param fieldName of field containing collection
