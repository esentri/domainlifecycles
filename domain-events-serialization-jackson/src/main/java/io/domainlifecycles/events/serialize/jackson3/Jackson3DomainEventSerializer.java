 ...
 * @author Mario Herb
 */
public class Jackson3DomainEventSerializer implements DomainEventSerializer {
     ...
     */
    public Jackson3DomainEventSerializer() {
     ...
     */
    public Jackson3DomainEventSerializer(DomainObjectBuilderProvider domainObjectBuilderProvider) {
        objectMapper = JsonMapper.builder()
