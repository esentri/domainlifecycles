...
public class TestMethodMatching {
    ...
    public static void before() throws URISyntaxException {
        ...
        var analyzer = new SootupStaticAnalyzer();
        String classpath = String.join(File.pathSeparator,
            new File(MyAggregateRoot.class.getProtectionDomain()
                .getCodeSource().getLocation().toURI()).getPath(),
            new File(AggregateRootBase.class.getProtectionDomain()
                .getCodeSource().getLocation().toURI()).getPath(),
            new File(JooqAggregateRepository.class.getProtectionDomain()
                .getCodeSource().getLocation().toURI()).getPath(),
            new File(PersistenceActionPublishingRepository.class.getProtectionDomain()
                .getCodeSource().getLocation().toURI()).getPath(),
            new File(Repository.class.getProtectionDomain()
                .getCodeSource().getLocation().toURI()).getPath()
        );
        calls = analyzer.analyze(Domain.getDomainMirror(), classpath);
    ...
    public void testCallsMyDomainService(){
        ...
        var called = calls.callsFor(new DomainCalls.MethodCall(m.getTypeName(),onMyDomainEvent.get()));
        ...
        assertThat(called.methods()).contains(new DomainCalls.MethodCall(repoMirror.getTypeName(), repoMirror.methodByName("findById")));
        var outboundMirror = Domain.getDomainMirror().getDomainTypeMirror(MyOutboundService.class.getTypeName()).get();
        assertThat(called.methods()).contains(new DomainCalls.MethodCall(outboundMirror.getTypeName(), outboundMirror.methodByName("doSomething")));
    }
    ...
    public void testCallsMyApplicationService(){
        ...
        var called = calls.callsFor(new DomainCalls.MethodCall(m.getTypeName(),method.get()));
        assertThat(called).isNotNull();
        ...
        assertThat(called.methods()).contains(new DomainCalls.MethodCall(commandMirror.getTypeName(), commandMirror.methodByName("id")));
        var repoMirror = Domain.getDomainMirror().getDomainTypeMirror(MyRepository.class.getTypeName()).get();
        assertThat(called.methods()).contains(new DomainCalls.MethodCall(repoMirror.getTypeName(), repoMirror.methodByName("findById")));
        assertThat(called.methods()).contains(new DomainCalls.MethodCall(repoMirror.getTypeName(), repoMirror.methodByName("update")));
        var aggregateRootMirror = Domain.getDomainMirror().getDomainTypeMirror(MyAggregateRoot.class.getTypeName()).get();
        assertThat(called.methods()).contains(new DomainCalls.MethodCall(aggregateRootMirror.getTypeName(), aggregateRootMirror.methodByName("doSomething")));
    }
    ...
    public void testNestedLambdas() {
        ...
        var called = calls.callsFor(
            new DomainCalls.MethodCall(m.getTypeName(), method.get()));
        assertThat(called).isNotNull();
        ...
        assertThat(called.methods()).contains(new DomainCalls.MethodCall(
    ...
    public void testPrivateHelperAsTarget() {
        ...
        var called = calls.callsFor(
            new DomainCalls.MethodCall(m.getTypeName(), doViaHelper.get()));
        assertThat(called).isNotNull();
    ...
    public void testPrivateHelperOwnCalls() {
        ...
        var calledByHelper = calls.callsFor(
            new DomainCalls.MethodCall(m.getTypeName(), helper.get()));
        assertThat(calledByHelper).isNotNull();

        var aggregateRootMirror = Domain.getDomainMirror().getDomainTypeMirror(
            MyAggregateRoot.class.getTypeName()).get();
        assertThat(calledByHelper.methods()).contains(new DomainCalls.MethodCall(
            aggregateRootMirror.getTypeName(),
            aggregateRootMirror.methodByName("doSomething")));
    }
    ...
    public void testSuperCall() {
        ...
        var called = calls.callsFor(
            new DomainCalls.MethodCall(serviceMirror.getTypeName(), overriding.get()));
        assertThat(called).isNotNull();
        ...
        assertThat(called.methods()).doesNotContain(new DomainCalls.MethodCall(
    ...
    public void testOverloadedMethods() {
        ...
        long handleCount = called.methods().stream()
            .filter(mc -> mc.method().getName().equals("handle"))
            .count();
    ...
    public void testGenericMethodWithBridge() {
        ...
        long findByIdCount = called.methods().stream()
            .filter(mc -> mc.method().getName().equals("findById"))
            .count();
    ...
    public void testRecursionTerminates() {
        ...
        var l2 = new DomainCalls.MethodCall(m.getTypeName(), m.methodByName("directRecursion"));
        var calledL2 = calls.callsFor(l2);
        assertThat(calledL2).isNotNull();
        assertThat(calledL2.methods()).contains(new DomainCalls.MethodCall(
            repoMirror.getTypeName(), repoMirror.methodByName("findById")));
        assertThat(calledL2.methods())
            .as("direct self-recursion must not list itself as a target")
            .doesNotContain(new DomainCalls.MethodCall(
        ...
        var mutualA = new DomainCalls.MethodCall(m.getTypeName(), m.methodByName("mutualA"));
        var calledA = calls.callsFor(mutualA);
        assertThat(calledA).isNotNull();
        assertThat(calledA.methods()).contains(new DomainCalls.MethodCall(
            m.getTypeName(), m.methodByName("mutualB")));

        var mutualB = new DomainCalls.MethodCall(m.getTypeName(), m.methodByName("mutualB"));
        var calledB = calls.callsFor(mutualB);
        assertThat(calledB).isNotNull();
        assertThat(calledB.methods()).contains(new DomainCalls.MethodCall(
    ...
    public void testAbstractAndBodylessMethodsProduceNoTargets() {
        ...
        var abstractCall = new DomainCalls.MethodCall(
        ...
        var interfaceCall = new DomainCalls.MethodCall(
