...
`api.io.domainlifecycles.jackson3.JacksonMappingCustomizer`.
...
By providing a `io.domainlifecycles.jackson3.api.EntityIdentityProvider` Jackson can tell how new IDs are generated for
Entities
...
the `io.domainlifecycles.jackson3.module.DlcJacksonModule` for this purpose.
