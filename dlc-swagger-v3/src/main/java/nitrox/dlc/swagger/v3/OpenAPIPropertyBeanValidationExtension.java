...
package nitrox.dlc.swagger.v3;

import io.swagger.v3.oas.models.OpenAPI;
import io.swagger.v3.oas.models.media.Schema;
import nitrox.dlc.reflect.JavaReflect;
import nitrox.dlc.reflect.MemberSelect;
...
import static nitrox.dlc.swagger.v3.Constants.IGNORED_RESPONSE_OBJECT_FQN;
...
public class OpenAPIPropertyBeanValidationExtension {
    ...
    private static void addSchemaDescription(String bundleKey, Schema<?> schema, String... replacement){
        var bundle = ResourceBundle.getBundle(nitrox.dlc.swagger.v3.resource.ResourceBundle.class.getName(), Locale.getDefault());
