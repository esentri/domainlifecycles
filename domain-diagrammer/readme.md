...
```Groovy
dependencies{
    testImplementation 'io.domainlifecycles:domain-diagrammer:3.1.0'
}
```
...
```Groovy
dependencies{
    implementation 'io.domainlifecycles:mirror:3.1.0'
    implementation 'io.domainlifecycles:types:3.1.0'
}
```
