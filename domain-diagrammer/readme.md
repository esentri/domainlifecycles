...
```Groovy
dependencies{
    testImplementation 'io.domainlifecycles:domain-diagrammer:3.4.0'
}
```
...
```Groovy
dependencies{
    implementation 'io.domainlifecycles:mirror:3.4.0'
    implementation 'io.domainlifecycles:types:3.4.0'
}
```
