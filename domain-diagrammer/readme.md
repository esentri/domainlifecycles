...
```Groovy
dependencies{
    testImplementation 'io.domainlifecycles:domain-diagrammer:3.3.0'
}
```
...
```Groovy
dependencies{
    implementation 'io.domainlifecycles:mirror:3.3.0'
    implementation 'io.domainlifecycles:types:3.3.0'
}
```
