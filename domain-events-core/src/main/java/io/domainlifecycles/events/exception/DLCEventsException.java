...
package io.domainlifecycles.events.exception;
 ...
 * @author Mario Herb
 */
public class DLCEventsException extends RuntimeException {


    /**
     * returns a new DLCEventsException with a detail message.
     *
     * @param detail exception message
     * @return new exception
     */
    public static DLCEventsException fail(final String detail) {
        return new DLCEventsException(requireNonNull(detail));
    }
    ...
    public static DLCEventsException fail(final String detail, final Throwable cause) {
        return new DLCEventsException(requireNonNull(detail), requireNonNull(cause));
    }
