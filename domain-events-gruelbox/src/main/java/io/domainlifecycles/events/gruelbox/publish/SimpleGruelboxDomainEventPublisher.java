...
/**
 * The SimpleGruelboxDomainEventPublisher class is responsible for publishing domain events to a transaction outbox.
 ...
 * @author Mario Herb
 */
public final class SimpleGruelboxDomainEventPublisher implements DomainEventPublisher {

    private static final Logger log = LoggerFactory.getLogger(SimpleGruelboxDomainEventPublisher.class);
    private final TransactionOutbox outbox;
    private final PublishingSchedulerConfiguration publishingSchedulerConfiguration;

    /**
     * The {@code SimpleGruelboxDomainEventPublisher} class is responsible for publishing domain events to a transaction outbox.
     ...
     */
    public SimpleGruelboxDomainEventPublisher(TransactionOutbox outbox,
