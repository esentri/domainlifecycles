...
import io.domainlifecycles.springboot4.config.PersistenceConfig;
import io.domainlifecycles.springboot4.persistence.base.SpringTestEventListener;
...
@ActiveProfiles({"test"})
public class BestellungRepository_SpringBoot4_ITest {

    private static final Logger log = org.slf4j.LoggerFactory.getLogger(BestellungRepository_SpringBoot4_ITest.class);
    @SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection")
    @Autowired
    private io.domainlifecycles.springboot4.persistence.bestellung.BestellungBv3Repository bestellungRepository;
