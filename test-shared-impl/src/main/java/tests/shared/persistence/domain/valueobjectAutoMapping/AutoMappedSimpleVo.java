...
@Getter
public class AutoMappedSimpleVo extends ValueObjectBase {

    public static final AutoMappedSimpleVo TEST_IGNORE_STATIC = new AutoMappedSimpleVo("STATIC");

    private final String value;

    @Builder(setterPrefix = "set")
    public AutoMappedSimpleVo(String value
    ) {
        this.value = value;
