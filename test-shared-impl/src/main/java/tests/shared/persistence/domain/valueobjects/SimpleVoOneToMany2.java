...
@Getter
public class SimpleVoOneToMany2 extends ValueObjectBase {

    private final String value;
    private final Set<SimpleVoOneToMany3> oneToMany3Set;

    @Builder(setterPrefix = "set")
    public SimpleVoOneToMany2(String value, Set<SimpleVoOneToMany3> oneToMany3Set) {
        this.value = value;
