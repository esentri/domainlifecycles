...
@Getter
public class TestEntityBOneToOneFollowingLeading extends EntityBase<TestEntityBOneToOneFollowingLeadingId> {

    private TestEntityBOneToOneFollowingLeadingId id;
    private String name;
    private TestRootOneToOneFollowingLeadingId testRootId;


    @Builder(setterPrefix = "set")
    public TestEntityBOneToOneFollowingLeading(TestEntityBOneToOneFollowingLeadingId id,
