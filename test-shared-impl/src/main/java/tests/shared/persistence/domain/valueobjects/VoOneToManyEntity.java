...
@Getter
public class VoOneToManyEntity extends ValueObjectBase {

    private final String value;
    private final Set<VoOneToManyEntity2> oneToManySet;

    @Builder(setterPrefix = "set")
    public VoOneToManyEntity(String value,
                             Set<VoOneToManyEntity2> oneToManySet
    ) {
        this.value = value;
