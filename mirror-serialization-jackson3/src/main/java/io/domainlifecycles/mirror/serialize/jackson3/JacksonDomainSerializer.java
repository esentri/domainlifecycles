...
package io.domainlifecycles.mirror.serialize.jackson3;
...
import io.domainlifecycles.mirror.serialize.jackson3.mirror.AggregateRootMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.AggregateRootReferenceMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.ApplicationServiceMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.AssertedContainableTypeMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.AssertionMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.BoundedContextMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.DomainCommandMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.DomainEventMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.DomainMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.DomainObjectMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.DomainServiceMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.DomainTypeMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.EntityMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.EntityReferenceMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.EnumMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.EnumOptionMirrorMixin;
...
import io.domainlifecycles.mirror.serialize.jackson3.mirror.RepositoryMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.ResolvedGenericTypeMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.ServiceKindMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.ValueObjectMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.mirror.ValueReferenceMirrorMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.AggregateRootModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.AggregateRootReferenceModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.ApplicationServiceModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.AssertedContainableTypeModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.AssertionModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.BoundedContextModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.DomainCommandModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.DomainEventModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.DomainModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.DomainObjectModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.DomainServiceModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.DomainTypeModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.EntityModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.EntityReferenceModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.EnumModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.EnumOptionModelMixin;
...
import io.domainlifecycles.mirror.serialize.jackson3.model.RepositoryModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.ServiceKindModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.ValueObjectModelMixin;
import io.domainlifecycles.mirror.serialize.jackson3.model.ValueReferenceModelMixin;
...
public class JacksonDomainSerializer implements DomainSerializer {
    ...
    public JacksonDomainSerializer(boolean prettyPrint) {
        JsonMapper.Builder jsonMapperBuilder = JsonMapper.builder()
            ...
            .addMixIn(RepositoryMirror.class, RepositoryMirrorMixin.class)
            .addMixIn(RepositoryModel.class, RepositoryModelMixin.class)
        ...
        jsonMapperBuilder.configure(DeserializationFeature.FAIL_ON_NULL_FOR_PRIMITIVES, false);
