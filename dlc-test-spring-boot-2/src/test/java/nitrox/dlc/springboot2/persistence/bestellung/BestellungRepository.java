...
package nitrox.dlc.springboot2.persistence.bestellung;
...
import nitrox.dlc.test.springboot2.Sequences;
import nitrox.dlc.test.springboot2.Tables;
import nitrox.dlc.test.springboot2.tables.records.AktionsCodeRecord;
import nitrox.dlc.test.springboot2.tables.records.BestellKommentarRecord;
import nitrox.dlc.test.springboot2.tables.records.BestellPositionRecord;
import nitrox.dlc.test.springboot2.tables.records.BestellStatusRecord;
import nitrox.dlc.test.springboot2.tables.records.BestellungRecord;
import nitrox.dlc.test.springboot2.tables.records.LieferadresseRecord;
...
public class BestellungRepository extends JooqAggregateRepository<Bestellung, BestellungId> {
    ...
    public Stream<Bestellung> findBestellungenOptimized(int offset, int pageSize) {
        ...
        nitrox.dlc.test.springboot2.tables.Bestellung b = Tables.BESTELLUNG.as("b");
