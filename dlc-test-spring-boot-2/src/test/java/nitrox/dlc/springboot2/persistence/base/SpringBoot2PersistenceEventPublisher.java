...
package nitrox.dlc.springboot2.persistence.base;
...
@Slf4j
@Component
public final class SpringBoot2PersistenceEventPublisher implements PersistenceEventPublisher {

    private final ApplicationEventPublisher applicationEventPublisher;

    public SpringBoot2PersistenceEventPublisher(ApplicationEventPublisher applicationEventPublisher) {
