...
package io.domainlifecycles.builder.exception;
 ...
 * @author Mario Herb
 */
public class DLCBuilderException extends RuntimeException {


    /**
     * returns a new DLCBuilderException with a detail message.
     *
     * @param detail exception message
     * @return new exception
     */
    public static DLCBuilderException fail(final String detail) {
        return new DLCBuilderException(requireNonNull(detail));
    }

    /**
     * returns a new DLCBuilderException with a detail message and a cause.
     *
     * @param detail exception message
     * @param cause Throwable
     * @return new exception
     */
    public static DLCBuilderException fail(final String detail, final Throwable cause) {
        return new DLCBuilderException(requireNonNull(detail), requireNonNull(cause));
    }

    /**
     * returns a new DLCBuilderException with a detail message formatted to include with given message parameters.
     *
     * @param detail exception message
    ...
    /**
     * returns a new DLCBuilderException with a detail message formatted to include with given message parameters and containing a cause.
     *
     * @param detail exception message
     * @param args message parameters
     * @param cause Throwable
