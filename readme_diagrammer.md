...
```Groovy
dependencies{
    testImplementation 'io.domainlifecycles:domain-diagrammer:2.0.5'
}
```
...
```Groovy
dependencies{
    implementation 'io.domainlifecycles:mirror:2.0.5'
    implementation 'io.domainlifecycles:types:2.0.5'
}
```
