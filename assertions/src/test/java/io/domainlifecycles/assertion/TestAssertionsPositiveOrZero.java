...
public class TestAssertionsPositiveOrZero {
    ...
    class TestIsPositiveOrZero {
        ...
        void assertInvalidIntValue(int value) {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(value, "message")).isInstanceOf(
        ...
        public void testIsPositiveOrZeroShortOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.isPositiveOrZero(Short.valueOf((short) 2), "Failed"));
        }
        ...
        public void testIsPositiveOrZeroShortFail() {
            assertThatThrownBy(
                () -> DomainAssertions.isPositiveOrZero(Short.valueOf((short) -1), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroIntegerFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(Integer.valueOf(-1), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroLongFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(Long.valueOf(-1l), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroDoubleFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(Double.valueOf(-1.0), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroFloatFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(Float.valueOf(-1.0f), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroBigDecimalOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.isPositiveOrZero(BigDecimal.valueOf(2.0), "Failed"));
        }
        ...
        public void testIsPositiveOrZeroBigDecimalFail() {
            assertThatThrownBy(
                () -> DomainAssertions.isPositiveOrZero(BigDecimal.valueOf(-1.0), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroBigIntegerOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.isPositiveOrZero(BigInteger.valueOf(2l), "Failed"));
        }
        ...
        public void testIsPositiveOrZeroBigIntegerFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(BigInteger.valueOf(-1l), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroBytePrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero((byte) -1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroShortPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero((short) -1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroIntPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(-1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroLongPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(-1l, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroDoublePrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(-1.0, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroFloatPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(-1.0f, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveOrZeroByteOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.isPositiveOrZero(Byte.valueOf((byte) 2), "Failed"));
        }
        ...
        public void testIsPositiveOrZeroByteFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositiveOrZero(Byte.valueOf((byte) -1), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
    }
    ...
    class TestOptionalIsPositiveOrZero {
        ...
        public void testOptionalIsPositiveOrZeroOkByte() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositiveOrZero(Optional.of(Byte.valueOf((byte) 2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOrZeroOkShort() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositiveOrZero(Optional.of(Short.valueOf((short) 2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOrZeroOkInteger() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositiveOrZero(Optional.of(Integer.valueOf(2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOrZeroOkLong() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositiveOrZero(Optional.of(Long.valueOf(2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOrZeroOkBigDecimal() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositiveOrZero(Optional.of(BigDecimal.valueOf(2.0)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOrZeroOkBigInteger() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositiveOrZero(Optional.of(BigInteger.valueOf(2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOrZeroOkDouble() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositiveOrZero(Optional.of(Double.valueOf(2.0)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOrZeroOkFloat() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositiveOrZero(Optional.of(Float.valueOf(2.0f)), "Failed"));
        }
        ...
        public void testOptionalIsPositiveOrZeroOkEmpty() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositiveOrZero(Optional.empty(), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOrZeroFail() {
            assertThatThrownBy(() -> DomainAssertions.optionalIsPositiveOrZero(Optional.of(Byte.valueOf((byte) -1)),
                "Failed")).isInstanceOf(DomainAssertionException.class);
        }

        @Test
        public void testOptionalIsPositiveOrZeroFailNull() {
            assertThatThrownBy(() -> DomainAssertions.optionalIsPositiveOrZero(null, "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }

        @Test
        public void testOptionalIsPositiveOrZeroFailWrongType() {
            assertThatThrownBy(() -> DomainAssertions.optionalIsPositiveOrZero(Optional.of(""), "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }
    }
}
