...
public class TestAssertionsPositive {
    ...
    class TestIsPositive {
        ...
        public void testIsPositiveShortFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(Short.valueOf((short) -1), "Failed")).isInstanceOf(
        ...
        public void testIsPositiveIntegerFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(Integer.valueOf(-1), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveLongFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(Long.valueOf(-1l), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveDoubleFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(Double.valueOf(-1.0), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveFloatFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(Float.valueOf(-1.0f), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveBigDecimalFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(BigDecimal.valueOf(-1.0), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveBigIntegerFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(BigInteger.valueOf(-1l), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveBytePrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive((byte) -1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveShortPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive((short) -1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveIntPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(-1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveLongPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(-1l, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveDoublePrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(-1.0, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveFloatPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(-1.0f, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsPositiveByteFail() {
            assertThatThrownBy(() -> DomainAssertions.isPositive(Byte.valueOf((byte) -1), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
    }
    ...
    class TestOptionalIsPositive {
        ...
        public void testOptionalIsPositiveOkByte() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositive(Optional.of(Byte.valueOf((byte) 2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOkShort() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositive(Optional.of(Short.valueOf((short) 2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOkInteger() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositive(Optional.of(Integer.valueOf(2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOkLong() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositive(Optional.of(Long.valueOf(2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOkBigDecimal() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositive(Optional.of(BigDecimal.valueOf(2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOkBigInteger() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositive(Optional.of(BigInteger.valueOf(2)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOkDouble() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositive(Optional.of(Double.valueOf(2.0)), "Failed"));
        }

        @Test
        public void testOptionalIsPositiveOkFloat() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsPositive(Optional.of(Float.valueOf(2.0f)), "Failed"));
        }
        ...
        public void testOptionalIsPositiveFail() {
            assertThatThrownBy(
                () -> DomainAssertions.optionalIsPositive(Optional.of(Byte.valueOf((byte) -1)), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }

        @Test
        public void testOptionalIsPositiveFailNull() {
            assertThatThrownBy(() -> DomainAssertions.optionalIsPositive(null, "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }

        @Test
        public void testOptionalIsPositiveFailWrongType() {
            assertThatThrownBy(() -> DomainAssertions.optionalIsPositive(Optional.of(""), "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }
    }
}
