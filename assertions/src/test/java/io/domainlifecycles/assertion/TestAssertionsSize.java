...
public class TestAssertionsSize {
    ...
    class TestHasSize {
        ...
        public void testHasSizeShortFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSize(List.of(1), 2, 3, "Failed")).isInstanceOf(DomainAssertionException.class);
        }

        @Test
        public void testHasSizeLongFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSize(List.of("abdbddb",1,3,4,5,5), 2, 3, "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testHasMapShortFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSize(Map.of(1,2), 2, 3, "Failed")).isInstanceOf(DomainAssertionException.class);
        }

        @Test
        public void testHasSizeMapLongFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSize(Map.of("abdbddb",1,3,4,5,5), 1, 2, "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testHasArrayShortFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSize(new Long[1], 2, 3, "Failed")).isInstanceOf(DomainAssertionException.class);
        }

        @Test
        public void testHasSizeArrayLongFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSize(new Date[8], 1, 2, "Failed")).isInstanceOf(DomainAssertionException.class);
        }
    ...
    class TestHasSizeMin {
        ...
        public void testHasSizeMinShortFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSizeMin(List.of(1), 2,  "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testHasSizeMapMinShortFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSizeMin(Map.of(1,2), 2,  "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testHasSizeArrayMinShortFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSizeMin(new Short[1], 2,  "Failed")).isInstanceOf(DomainAssertionException.class);
        }
    ...
    class TestHasSizeMax {
        ...
        public void testHasSizeMaxLongFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSizeMax(List.of(1,45,6), 2,  "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testHasSizeMapMaxLongFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSizeMax(Map.of(1,45,6,6), 1,  "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testHasSizeArrayMaxLongFail(){
            assertThatThrownBy(()-> DomainAssertions.hasSizeMax(new String[2], 1,  "Failed")).isInstanceOf(DomainAssertionException.class);
        }
