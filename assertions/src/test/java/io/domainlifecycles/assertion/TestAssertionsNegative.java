...
public class TestAssertionsNegative {
    ...
    class TestIsNegative {
        ...
        public void testIsNegativeBigIntegerFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(BigInteger.valueOf(0L), "Failed")).isInstanceOf(
        ...
        public void testIsNegativeBytePrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative((byte) 0, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeShortPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative((short) 0, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeIntPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(0, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeLongPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(0L, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeDoublePrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(0.0, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeFloatPrimitiveFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(0.0f, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeByteFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(Byte.valueOf((byte) 0), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeShortFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(Short.valueOf((short) 0), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeIntegerFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(Integer.valueOf(0), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeLongFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(Long.valueOf(0L), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeDoubleFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(Double.valueOf(0.0), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeFloatFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(Float.valueOf(0.0f), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testIsNegativeBigDecimalFail() {
            assertThatThrownBy(() -> DomainAssertions.isNegative(BigDecimal.valueOf(0.0), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
    }
    ...
    class TestOptionalIsNegative {
        ...
        public void testOptionalIsNegativeOkByte() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsNegative(Optional.of(Byte.valueOf((byte) -1)), "Failed"));
        }

        @Test
        public void testOptionalIsNegativeOkShort() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsNegative(Optional.of(Short.valueOf((short) -1)), "Failed"));
        }

        @Test
        public void testOptionalIsNegativeOkInteger() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsNegative(Optional.of(Integer.valueOf(-1)), "Failed"));
        }

        @Test
        public void testOptionalIsNegativeOkLong() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsNegative(Optional.of(Long.valueOf(-1)), "Failed"));
        }

        @Test
        public void testOptionalIsNegativeOkBigDecimal() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsNegative(Optional.of(BigDecimal.valueOf(-1.0)), "Failed"));
        }

        @Test
        public void testOptionalIsNegativeOkBigInteger() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsNegative(Optional.of(BigInteger.valueOf(-1)), "Failed"));
        }

        @Test
        public void testOptionalIsNegativeOkDouble() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsNegative(Optional.of(Double.valueOf(-1.0)), "Failed"));
        }

        @Test
        public void testOptionalIsNegativeOkFloat() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalIsNegative(Optional.of(Float.valueOf(-1.0F)), "Failed"));
        }
        ...
        public void testOptionalIsNegativeFail() {
            assertThatThrownBy(
                () -> DomainAssertions.optionalIsNegative(Optional.of(Byte.valueOf((byte) 0)), "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }

        @Test
        public void testOptionalIsNegativeFailNull() {
            assertThatThrownBy(() -> DomainAssertions.optionalIsNegative(null, "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }

        @Test
        public void testOptionalIsNegativeFailWrongType() {
            assertThatThrownBy(() -> DomainAssertions.optionalIsNegative(Optional.of(""), "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }
    }
}
