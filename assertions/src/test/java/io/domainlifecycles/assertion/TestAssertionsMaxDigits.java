...
public class TestAssertionsMaxDigits {
    ...
    class TestHasMaxDigits {
        ...
        public void testHasMaxDigitsFailInteger() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigits(BigDecimal.valueOf(12.23), 1, 2, "Failed")).isInstanceOf(
        ...
        public void testHasMaxDigitsFailFraction() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigits(BigDecimal.valueOf(12.234), 1, 2, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigits(BigDecimal.valueOf(12.234), 2, 3, "Failed"));
        }
        ...
        public void testHasMaxDigitsFailDoublePrimitive() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigits(12.1, 1, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsFailDouble() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigits(Double.valueOf(12.1), 1, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsOkDouble() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigits(Double.valueOf(12.2), 2, 1, "Failed"));
        }
        ...
        public void testHasMaxDigitsFailFloatPrimitive() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigits(10.0f, 1, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsFailFloat() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigits(Float.valueOf(10.1f), 1, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsOkFloat() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigits(Float.valueOf(10.1f), 2, 1, "Failed"));
        }
    ...
    class TestHasMaxDigitsInteger {
        ...
        public void testHasMaxDigitsIntegerFail() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(BigDecimal.valueOf(12.23), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(BigDecimal.valueOf(12.234), 2, "Failed"));
        }

        @Test
        public void testHasMaxDigitsIntegerNullOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger((BigDecimal) null, 2, "Failed"));
        }

        @Test
        public void testHasMaxDigitsIntegerFailBigInteger() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(BigInteger.valueOf(12), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerOkBigInteger() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(BigInteger.valueOf(12), 2, "Failed"));
        }

        @Test
        public void testHasMaxDigitsIntegerNullOkBigInteger() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger((BigInteger) null, 2, "Failed"));
        }

        @Test
        public void testHasMaxDigitsIntegerFailDoublePrimitive() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigitsInteger(12.1, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerFailDouble() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Double.valueOf(12.1), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerOkDouble() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Double.valueOf(12.2), 2, "Failed"));
        }
        ...
        public void testHasMaxDigitsIntegerFailFloatPrimitive() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigitsInteger(10.1f, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerFailFloat() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Float.valueOf(10.1f), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerOkFloat() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Float.valueOf(10.1f), 2, "Failed"));
        }
        ...
        public void testHasMaxDigitsIntegerFailIntPrimitive() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigitsInteger(12, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerFailInteger() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Integer.valueOf(12), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerOkInteger() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Integer.valueOf(12), 2, "Failed"));
        }
        ...
        public void testHasMaxDigitsIntegerFailLongPrimitive() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigitsInteger(12l, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerFailLong() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigitsInteger(Long.valueOf(12), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerOkLong() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Long.valueOf(12), 2, "Failed"));
        }
        ...
        public void testHasMaxDigitsIntegerFailShortPrimitive() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigitsInteger((short) 12, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerFailShort() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Short.valueOf((short) 12), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerOkShort() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Short.valueOf((short) 12), 2, "Failed"));
        }
        ...
        public void testHasMaxDigitsIntegerFailBytePrimitive() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigitsInteger((byte) 12, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerFailByte() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Byte.valueOf((byte) 12), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsIntegerOkByte() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsInteger(Byte.valueOf((byte) 12), 2, "Failed"));
        }
    ...
    class TestHasMaxDigitsFraction {
        ...
        public void testHasMaxDigitsFractionFail() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigitsFraction(BigDecimal.valueOf(12.23), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsFractionOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsFraction(BigDecimal.valueOf(12.234), 3, "Failed"));
        }

        @Test
        public void testHasMaxDigitsFractionNullOkBigDecimal() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsFraction((BigDecimal) null, 2, "Failed"));
        }

        @Test
        public void testHasMaxDigitsFractionFailDoublePrimitive() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigitsFraction(12.13, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsFractionFailDouble() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigitsFraction(Double.valueOf(12.13), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsFractionOkDouble() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsFraction(Double.valueOf(10.2), 1, "Failed"));
        }
        ...
        public void testHasMaxDigitsFractionFailFloatPrimitive() {
            assertThatThrownBy(() -> DomainAssertions.hasMaxDigitsFraction(12.12f, 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsFractionFailFloat() {
            assertThatThrownBy(
                () -> DomainAssertions.hasMaxDigitsFraction(Float.valueOf(10.25f), 1, "Failed")).isInstanceOf(
                DomainAssertionException.class);
        }
        ...
        public void testHasMaxDigitsFractionOkFloat() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.hasMaxDigitsFraction(Float.valueOf(10.1f), 1, "Failed"));
        }
    ...
    class TestOptionalHasMaxDigits {
        ...
        public void testOptionalHasMaxDigitsBigDecimalOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigits(Optional.of(BigDecimal.valueOf(12.234)), 2, 3, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsBigDecimalFail() {
            assertThatThrownBy(() -> DomainAssertions.optionalHasMaxDigits(Optional.of(BigDecimal.valueOf(12.23)), 1, 2,
        ...
        public void testOptionalHasMaxDigitsDoubleOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigits(Optional.of(Double.valueOf(12.23)), 2, 2, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsDoubleFailInt() {
            assertThatThrownBy(() -> DomainAssertions.optionalHasMaxDigits(Optional.of(Double.valueOf(12.23)), 1, 2,
                "Failed")).isInstanceOf(DomainAssertionException.class);
        }

        @Test
        public void testOptionalHasMaxDigitsDoubleFailFrac() {
            assertThatThrownBy(() -> DomainAssertions.optionalHasMaxDigits(Optional.of(Double.valueOf(12.23)), 2, 1,
                "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testOptionalHasMaxDigitsFloatOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigits(Optional.of(Float.valueOf(12.23f)), 2, 2, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsFloatFailInt() {
            assertThatThrownBy(() -> DomainAssertions.optionalHasMaxDigits(Optional.of(Float.valueOf(12.23f)), 1, 2,
                "Failed")).isInstanceOf(DomainAssertionException.class);
        }

        @Test
        public void testOptionalHasMaxDigitsFloatFailFrac() {
            assertThatThrownBy(() -> DomainAssertions.optionalHasMaxDigits(Optional.of(Float.valueOf(12.23f)), 2, 1,
                "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testOptionalHasMaxDigitsEmptyOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigits(Optional.empty(), 2, 3, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsFailNull() {
            assertThatThrownBy(() -> DomainAssertions.optionalHasMaxDigits(null, 1, 2, "Failed")).isInstanceOf(
        ...
        public void testOptionalHasMaxDigitsFailWrongType() {
            assertThatThrownBy(
                () -> DomainAssertions.optionalHasMaxDigits(Optional.of("a"), 1, 2, "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }
    }
    ...
    class TestOptionalHasMaxDigitsInteger {
        ...
        public void testOptionalHasMaxDigitsIntegerFail() {
            assertThatThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.of(BigDecimal.valueOf(12.23)), 1,
                    "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testOptionalHasMaxDigitsIntegerBigDecimalOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.of(BigDecimal.valueOf(12.234)), 2,
                    "Failed"));
        }
        ...
        public void testOptionalHasMaxDigitsIntegerDoubleOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.of(Double.valueOf(12.234)), 2, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsIntegerFloatOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.of(Float.valueOf(10.1f)), 2, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsIntegerIntegerOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.of(Integer.valueOf(12)), 2, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsIntegerLongOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.of(Long.valueOf(12)), 2, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsIntegerBigIntegerOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.of(BigInteger.valueOf(12)), 2, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsIntegerByteOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.of(Byte.valueOf((byte) 12)), 2, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsIntegerShortOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.of(Short.valueOf((short) 12)), 2,
                    "Failed"));
        }
        ...
        public void testHasMaxDigitsIntegerEmptyOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.empty(), 2, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsIntegerNullFail() {
            assertThatThrownBy(() -> DomainAssertions.optionalHasMaxDigitsInteger(null, 1, "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }
        ...
        public void testOptionalHasMaxDigitsIntegerWrongTypeFail() {
            assertThatThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsInteger(Optional.of("sdad"), 1, "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }
    }
    ...
    class TestOptionalHasMaxDigitsFraction {
        ...
        public void testOptionalHasMaxDigitsFractionBigDecimalFail() {
            assertThatThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsFraction(Optional.of(BigDecimal.valueOf(12.23)), 1,
                    "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testOptionalHasMaxDigitsFractionBigDecimalOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsFraction(Optional.of(BigDecimal.valueOf(12.234)), 3,
                    "Failed"));
        }
        ...
        public void testOptionalHasMaxDigitsFractionDoubleFail() {
            assertThatThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsFraction(Optional.of(Double.valueOf(12.23)), 1,
                    "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testOptionalHasMaxDigitsFractionDoubleOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsFraction(Optional.of(Double.valueOf(12.234)), 3, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsFractionFloatFail() {
            assertThatThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsFraction(Optional.of(Float.valueOf(12.23F)), 1,
                    "Failed")).isInstanceOf(DomainAssertionException.class);
        }
        ...
        public void testOptionalHasMaxDigitsFractionFloatOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsFraction(Optional.of(Float.valueOf(12.234F)), 3, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsFractionEmptyOk() {
            assertThatNoException().isThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsFraction(Optional.empty(), 2, "Failed"));
        }

        @Test
        public void testOptionalHasMaxDigitsFractionNullFail() {
            assertThatThrownBy(() -> DomainAssertions.optionalHasMaxDigitsFraction(null, 1, "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }
        ...
        public void testOptionalHasMaxDigitsFractionWrongTypeFail() {
            assertThatThrownBy(
                () -> DomainAssertions.optionalHasMaxDigitsFraction(Optional.of("sdfse"), 1, "Failed")).isInstanceOf(
                IllegalArgumentException.class);
        }
    }
}
