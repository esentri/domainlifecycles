...
/**
 * All domain types mirrored, that can process {@link nitrox.dlc.domain.types.DomainEvent} instances, implement this interface.
 *
 * @author Mario Herb
 */
public interface DomainEventProcessingMirror {
     ...
     * To be more precise, if the mirrored type contains a method, which is annotated to do so {@link nitrox.dlc.domain.types.Publishes}.
     ...
     * To be more precise, if the mirrored type contains a method, which is annotated to do so {@link nitrox.dlc.domain.types.ListensTo}.
