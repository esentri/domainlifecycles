...
/**
 * A Repository Mirror mirrors {@link nitrox.dlc.domain.types.Repository} instances.
 *
 * @author Mario Herb
 */
public interface RepositoryMirror extends DomainTypeMirror, DomainCommandProcessingMirror, DomainEventProcessingMirror{
     ...
     * The interfaces therefore must extend {@link nitrox.dlc.domain.types.Repository}.
