...
/**
 * A DomainServiceMirror mirrors {@link nitrox.dlc.domain.types.DomainService} instances.
 *
 * @author Mario Herb
 */
public interface DomainServiceMirror extends DomainTypeMirror, DomainCommandProcessingMirror, DomainEventProcessingMirror{
    ...
    /**
     * Returns the list of mirrors for the {@link nitrox.dlc.domain.types.Repository} instances referenced by the DomainService.
     */
    List<RepositoryMirror> getReferencedRepositories();

    /**
     * Returns the list of mirrors for the {@link nitrox.dlc.domain.types.DomainService} instances referenced by the DomainService.
     */
    List<DomainServiceMirror> getReferencedDomainServices();

    /**
     * Returns the interface type names (full qualified class names) that the mirrored DomainService implements.
     * The interfaces therefore must extend {@link nitrox.dlc.domain.types.DomainService}.
