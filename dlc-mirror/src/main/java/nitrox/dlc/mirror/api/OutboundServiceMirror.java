...
/**
 * OutboundServiceMirror mirrors {@link nitrox.dlc.domain.types.OutboundService} instances.
 *
 * @author Mario Herb
 */
public interface OutboundServiceMirror extends DomainTypeMirror, DomainCommandProcessingMirror, DomainEventProcessingMirror{
     ...
     * The interfaces therefore must extend {@link nitrox.dlc.domain.types.OutboundService}.
