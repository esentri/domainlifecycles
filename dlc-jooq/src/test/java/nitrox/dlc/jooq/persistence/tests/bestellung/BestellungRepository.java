...
package nitrox.dlc.jooq.persistence.tests.bestellung;
...
import nitrox.dlc.test.Sequences;
import nitrox.dlc.test.Tables;
import nitrox.dlc.test.tables.records.AktionsCodeRecord;
import nitrox.dlc.test.tables.records.BestellKommentarRecord;
import nitrox.dlc.test.tables.records.BestellPositionRecord;
import nitrox.dlc.test.tables.records.BestellStatusRecord;
import nitrox.dlc.test.tables.records.BestellungRecord;
import nitrox.dlc.test.tables.records.LieferadresseRecord;
...
public class BestellungRepository extends JooqAggregateRepository<Bestellung, BestellungId> {
    ...
    public Stream<Bestellung> findBestellungenOptimized(int offset, int pageSize) {
        ...
        nitrox.dlc.test.tables.Bestellung b = Tables.BESTELLUNG.as("b");
