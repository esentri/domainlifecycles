...
package nitrox.dlc.jooq.persistence.tests.fetcher;

import nitrox.dlc.builder.DomainObjectBuilder;
import nitrox.dlc.domain.types.Entity;
import nitrox.dlc.jooq.imp.JooqAggregateFetcher;
import nitrox.dlc.jooq.persistence.tests.hierarchical.HierarchicalAggregateRootRepository;
import nitrox.dlc.jooq.persistence.tests.hierarchicalBackRef.HierarchicalAggregateRootBackrefRepository;
import nitrox.dlc.jooq.persistence.tests.manyToManyWithJoinEntity.ManyToManyAggregateRootRepository;
import nitrox.dlc.jooq.persistence.tests.oneToMany.OneToManyAggregateRootRepository;
import nitrox.dlc.jooq.persistence.tests.oneToOneFollowingFK.OneToOneFollowingAggregateRootRepository;
import nitrox.dlc.jooq.persistence.tests.oneToOneFollowingLeadingFK.OneToOneFollowingLeadingAggregateRootRepository;
import nitrox.dlc.jooq.persistence.tests.oneToOneLeadingFK.OneToOneLeadingAggregateRootRepository;
...
import nitrox.dlc.jooq.persistence.tests.complex.ComplexAggregateRootRepository;
import nitrox.dlc.test.tables.records.TestEntityOneToManyRecord;
...
import nitrox.dlc.test.tables.records.TestRootHierarchicalBackrefRecord;
import nitrox.dlc.test.tables.records.TestRootHierarchicalRecord;
import nitrox.dlc.test.tables.records.TestRootOneToManyRecord;
import nitrox.dlc.test.tables.records.TestRootOneToOneFollowingRecord;
