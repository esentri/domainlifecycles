...
package nitrox.dlc.springdoc.openapi;

import io.swagger.v3.oas.models.OpenAPI;
import nitrox.dlc.access.classes.ClassProvider;
import nitrox.dlc.swagger.v3.MirrorBasedOpenApiExtension;
import nitrox.dlc.swagger.v3.OpenAPIPrimitivePropertyExtension;
import nitrox.dlc.swagger.v3.OpenAPIPropertyBeanValidationExtension;
import nitrox.dlc.swagger.v3.OpenAPITemporalTypeExtension;
 ...
 * <p>
 * A note for the application of the error management of this extension: Any exception or error which happens when trying to
 * modify or extend the Open API behaviour of any class, results in an error log message without, stooping the extension or
