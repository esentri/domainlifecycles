...
@AutoConfigureBefore(name="org.springframework.boot.jackson2.autoconfigure.Jackson2AutoConfiguration")
@ConditionalOnClass(name="com.fasterxml.jackson.databind.ObjectMapper")
@ConditionalOnProperty(prefix = "dlc.features.jackson2", name = "enabled", havingValue = "true", matchIfMissing = true)
public class DlcJackson2AutoConfiguration {
    ...
    public DlcJacksonModule dlcModule2ConfigurationWithEntityIdentityProvider(List<? extends JacksonMappingCustomizer<?>> customizers,
    ...
    public DlcJacksonModule dlcModule2ConfigurationWithoutEntityIdentityProvider(List<? extends JacksonMappingCustomizer<?>> customizers,
                                                                         DomainObjectBuilderProvider domainObjectBuilderProvider
    ) {
