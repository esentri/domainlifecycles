...
public class TestApplicationGruelboxEventAndBuilderAndJacksonAndPersistenceAndServiceKindAutoConfiguration {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(
            TestApplicationGruelboxEventAndBuilderAndJacksonAndPersistenceAndServiceKindAutoConfiguration.class).run(args);
    }
}
