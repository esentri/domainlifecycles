...
@SpringBootTest(classes = TestApplicationEvents.class, properties = {"dlc.events.notx.enabled=true", "dlc.events.springtx.enabled=true", "dlc.events.springbus.enabled=false"})
