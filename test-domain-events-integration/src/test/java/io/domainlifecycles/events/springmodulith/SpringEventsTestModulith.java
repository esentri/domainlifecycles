...
import testdomain.modulith.A2ndDomainEvent;
import testdomain.modulith.ADomainEvent;
import testdomain.modulith.ADomainService;
import testdomain.modulith.ARepository;
import testdomain.modulith.AnAggregate;
...
@SpringBootTest(
    classes = TestApplicationSpringEventsModulith.class,
...
public class SpringEventsTestModulith {
