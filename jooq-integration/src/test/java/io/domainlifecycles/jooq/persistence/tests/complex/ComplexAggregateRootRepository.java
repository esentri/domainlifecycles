...
import io.domainlifecycles.test.jooq.tables.records.TestEntity_1Record;
import io.domainlifecycles.test.jooq.tables.records.TestEntity_2Record;
import io.domainlifecycles.test.jooq.tables.records.TestEntity_3Record;
import io.domainlifecycles.test.jooq.tables.records.TestEntity_4Record;
import io.domainlifecycles.test.jooq.tables.records.TestEntity_5Record;
import io.domainlifecycles.test.jooq.tables.records.TestEntity_6Record;
