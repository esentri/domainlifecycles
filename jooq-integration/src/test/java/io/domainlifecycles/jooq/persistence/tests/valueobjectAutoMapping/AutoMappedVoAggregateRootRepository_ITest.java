...
public class AutoMappedVoAggregateRootRepository_ITest extends BasePersistence_ITest {
    ...
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(
        AutoMappedVoAggregateRootRepository_ITest.class);
    ...
    public void testInsertMin() {
        ...
        //then
        Optional<AutoMappedVoAggregateRoot> found = voAggregateRootRepository.findResultById(
                new AutoMappedVoAggregateRootId(2l))
            .resultValue();
    ...
    public void testInsertMiddle() {
        ...
        //then
        Optional<AutoMappedVoAggregateRoot> found = voAggregateRootRepository.findResultById(
            new AutoMappedVoAggregateRootId(1l)).resultValue();
    ...
    public void testInsertMax() {
        ...
        //then
        Optional<AutoMappedVoAggregateRoot> found = voAggregateRootRepository.findResultById(
            new AutoMappedVoAggregateRootId(3l)).resultValue();
        assertThat(inserted == copy);
        persistenceEventTestHelper.assertFoundWithResult(found, inserted);
        Assertions.assertThat(found.get().getValueObjectsOneToMany()).isNotEmpty();
        log.debug("Neue VO Aggregate Root: \n" + found);
        ...
        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.INSERTED,
            inserted.getValueObjectsOneToMany2().get(0).getOneToMany3Set().toArray(
                i -> new AutoMappedSimpleVoOneToMany3[i])[0], inserted);
        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.INSERTED,
            inserted.getValueObjectsOneToMany2().get(0).getOneToMany3Set().toArray(
                i -> new AutoMappedSimpleVoOneToMany3[i])[1], inserted);
        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.INSERTED,
            inserted.getValueObjectsOneToMany2().get(1), inserted);
        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.INSERTED,
            inserted.getValueObjectsOneToMany2().get(2), inserted);
        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.INSERTED,
            inserted.getValueObjectsOneToMany2().get(2).getOneToMany3Set().toArray(
                i -> new AutoMappedSimpleVoOneToMany3[i])[0], inserted);
        persistenceEventTestHelper.assertEvents();
    }
    ...
    public void testInsertMaxWithEntity() {
        ...
        //then
        Optional<AutoMappedVoAggregateRoot> found = voAggregateRootRepository.findResultById(
            new AutoMappedVoAggregateRootId(4l)).resultValue();
        ...
        for (int i = entityArray.length - 1; i >= 0; i--) {
            ...
            if (entity.getValueObjectsOneToMany() != null && entity.getValueObjectsOneToMany().size() > 0) {
                AutoMappedVoOneToManyEntity[] voOuterArray = entity.getValueObjectsOneToMany().toArray(
                    j -> new AutoMappedVoOneToManyEntity[j]);
                for (int j = voOuterArray.length - 1; j >= 0; j--) {
                    ...
                    if (voOuter.getOneToManySet() != null && voOuter.getOneToManySet().size() > 0) {
                        AutoMappedVoOneToManyEntity2[] voInnerArray = voOuter.getOneToManySet().toArray(
                            k -> new AutoMappedVoOneToManyEntity2[k]);
    ...
    public void testUpdateMaxAddVo3() {
        ...
        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.INSERTED,
            updated.getValueObjectsOneToMany2().get(0).getOneToMany3Set().toArray(
                i -> new AutoMappedSimpleVoOneToMany3[i])[0], updated);
        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.INSERTED,
            updated.getValueObjectsOneToMany2().get(0).getOneToMany3Set().toArray(
                i -> new AutoMappedSimpleVoOneToMany3[i])[1], updated);

        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.INSERTED,
            updated.getValueObjectsOneToMany2().get(0).getOneToMany3Set().toArray(
                i -> new AutoMappedSimpleVoOneToMany3[i])[2], updated);
        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.UPDATED, updated);
    ...
    public void testUpdateMaxWithEntityRemoveEntity() {
        ...
        if (removedEntity.getValueObjectsOneToMany() != null && removedEntity.getValueObjectsOneToMany().size() > 0) {
            AutoMappedVoOneToManyEntity[] voOuterArray = removedEntity.getValueObjectsOneToMany().toArray(
                j -> new AutoMappedVoOneToManyEntity[j]);
            for (int j = voOuterArray.length - 1; j >= 0; j--) {
                AutoMappedVoOneToManyEntity voOuter = voOuterArray[j];
                persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.DELETED, voOuter,
    ...
    public void testUpdateMaxWithEntityAddEntity() {
        ...
        copy.getEntities().add(AutoMappedVoEntity.builder()
            ...
            .setMyComplexVo(AutoMappedComplexVo.builder()
                ...
                .build())
            .setValueObjectsOneToMany(new HashSet<>(
                TestDataGenerator.newArrayListOf(AutoMappedVoOneToManyEntity.builder().setValue("Neu VO").build())))
            .build()
        );
        ...
        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.INSERTED,
            updated.getEntities().get(3).getValueObjectsOneToMany().toArray(i -> new AutoMappedVoOneToManyEntity[i])[0],
            updated.getEntities().get(3));
        persistenceEventTestHelper.addExpectedEvent(PersistenceEvent.PersistenceEventType.UPDATED, updated);
    ...
    public void testUpdateMaxWithEntityAddVoAndDeleteVo() {
        ...
        AutoMappedVoOneToManyEntity toRemove = updatedEntity.getValueObjectsOneToMany().toArray(
            i -> new AutoMappedVoOneToManyEntity[i])[0];
        ...
        if (toRemove.getOneToManySet() != null) {
            AutoMappedVoOneToManyEntity2[] removed = toRemove.getOneToManySet().toArray(
                j -> new AutoMappedVoOneToManyEntity2[j]);
            if (removed.length > 0) {
    ...
    public void testUpdateMaxWithEntityDeleteVo() {
        ...
        //when
        AutoMappedVoOneToManyEntity vo = copy.getEntities().get(0).getValueObjectsOneToMany().stream().filter(
            v -> v.getValue().equals("vo1")).toArray(i -> new AutoMappedVoOneToManyEntity[i])[0];
        ...
        inserted.getEntities().get(0).getValueObjectsOneToMany().stream().filter(
            ...
            i -> new AutoMappedVoOneToManyEntity[i])[0].getOneToManySet().stream().forEach(v ->
    ...
    public void testUpdateMinSimpleVO() {
        ...
        //then
        Optional<AutoMappedVoAggregateRoot> found = voAggregateRootRepository.findResultById(
            new AutoMappedVoAggregateRootId(2l)).resultValue();
