...
/**
 * Builder to create {@link ServiceMirrorBuilder}
 *
 * @author leonvoellinger
 */
public class ServiceMirrorBuilder extends DomainTypeMirrorBuilder<ServiceKindMirror> {
     ...
     */
    public ServiceMirrorBuilder(Class<?> serviceKindClass, GenericTypeResolver genericTypeResolver) {
