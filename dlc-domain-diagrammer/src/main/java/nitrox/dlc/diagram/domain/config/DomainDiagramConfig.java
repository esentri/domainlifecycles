...
package nitrox.dlc.diagram.domain.config;

import lombok.Builder;
import lombok.Getter;
import nitrox.dlc.diagram.DiagramConfig;
...
public class DomainDiagramConfig implements DiagramConfig {
    ...
    /**
     * Enabling and initializing the seed for the {@link nitrox.dlc.diagram.domain.mapper.TransitiveDomainTypeFilter}.
     */
    @Builder.Default
