...
package nitrox.dlc.domain.types.exception;
...
public class DLCTypesException extends RuntimeException {
    ...
    /**
     * returns a new DLCTypesException with a detail message.
     *
     * @param detail exception message
     * @return new exception
     */
    public static DLCTypesException fail(final String detail) {
        return new DLCTypesException(requireNonNull(detail));
    }

    /**
     * returns a new DLCTypesException with a detail message and a cause.
     *
     * @param detail exception message
     * @param cause Throwable
     * @return new exception
     */
    public static DLCTypesException fail(final String detail, final Throwable cause) {
        return new DLCTypesException(requireNonNull(detail), requireNonNull(cause));
    }

    /**
     * returns a new DLCTypesException with a detail message formatted to include with given message parameters.
     *
     * @param detail exception message
    ...
    /**
     * returns a new DLCTypesException with a detail message formatted to include with given message parameters and containing a cause.
     *
     * @param detail exception message
     * @param args message parameters
     * @param cause Throwable
