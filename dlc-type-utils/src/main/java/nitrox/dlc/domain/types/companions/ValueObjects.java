...
package nitrox.dlc.domain.types.companions;
...
public class ValueObjects {
     ...
     * In DDD and NitroX DLC entities are considered to be equal, if all of their contained values are equal (deep equality).
     *
