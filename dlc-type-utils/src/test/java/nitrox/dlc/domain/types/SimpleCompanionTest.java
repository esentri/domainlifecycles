...
import nitrox.dlc.domain.types.companions.Entities;
import nitrox.dlc.domain.types.companions.ValueObjects;
...
public class SimpleCompanionTest {
    ...
    public void testEntityEqualsFalse(){
        ...
        assertThat(Entities.equals(e1, e2)).isFalse();
    }
    ...
    public void testId(){
        ...
        assertThat(Entities.id(e1)).isEqualTo(new TestEntityId(1L));
    }
