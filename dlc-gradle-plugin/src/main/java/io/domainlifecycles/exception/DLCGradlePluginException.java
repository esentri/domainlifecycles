 ...
 * @author Mario Herb
 */
public class DLCGradlePluginException extends RuntimeException {
     ...
     */
    public static DLCGradlePluginException fail(final String detail) {
        return new DLCGradlePluginException(requireNonNull(detail));
    }
     ...
     */
    public static DLCGradlePluginException fail(final String detail, final Throwable cause) {
        return new DLCGradlePluginException(requireNonNull(detail), requireNonNull(cause));
    }
