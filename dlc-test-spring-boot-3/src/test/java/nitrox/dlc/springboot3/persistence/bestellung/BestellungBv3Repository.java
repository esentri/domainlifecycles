...
import nitrox.dlc.test.springboot3.Sequences;
import nitrox.dlc.test.springboot3.tables.records.AktionsCodeBv3Record;
import nitrox.dlc.test.springboot3.tables.records.BestellKommentarBv3Record;
import nitrox.dlc.test.springboot3.tables.records.BestellPositionBv3Record;
import nitrox.dlc.test.springboot3.tables.records.BestellStatusBv3Record;
import nitrox.dlc.test.springboot3.tables.records.BestellungBv3Record;
import nitrox.dlc.test.springboot3.tables.records.LieferadresseBv3Record;
...
import static nitrox.dlc.test.springboot3.Tables.AKTIONS_CODE_BV3;
import static nitrox.dlc.test.springboot3.Tables.BESTELLUNG_BV3;
import static nitrox.dlc.test.springboot3.Tables.BESTELL_KOMMENTAR_BV3;
import static nitrox.dlc.test.springboot3.Tables.BESTELL_POSITION_BV3;
import static nitrox.dlc.test.springboot3.Tables.LIEFERADRESSE_BV3;
import static nitrox.dlc.test.springboot3.tables.BestellStatusBv3.BESTELL_STATUS_BV3;
...
public class BestellungBv3Repository extends JooqAggregateRepository<BestellungBv3, BestellungIdBv3> {
    ...
    public Stream<BestellungBv3> findBestellungenOptimized(int offset, int pageSize) {
        ...
        nitrox.dlc.test.springboot3.tables.BestellungBv3 b = BESTELLUNG_BV3.as("b");
