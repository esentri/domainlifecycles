...
/**
 * This is the marker interface to represent DomainEvents that are automatically dispatched to a method in an
 * Aggregate (by using the dlc-domain-events module).
 *
