 ...
 * One might think of using the built-in bean validation metadata facilities, but to use them a bean validation
 * provider must be
 ...
 * support for both Bean Validation 2.0 and 3.0, we might stick to this way of implementing bean validation supported
 * assertion mirrors.
 *
 * @author Mario Herb
 */
