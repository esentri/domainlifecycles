...
Zusätzlich zur folgenden Konfiguration finden sich [hier](../features/domainobject_builders_de.md) Beispiele zur Implementierung.
...
## Domain-Types
Zusätzlich zur folgenden Konfiguration finden sich [hier](../features/domain_types_de.md) Beispiele zur Implementierung.
...
|:-----------------------------------------:|:-----------------------------------------:|
| [<< Previous](create_project_de.md) | [Nächste Seite >>](run_application_de.md) |
