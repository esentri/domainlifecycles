package io.domainlifecycles.boot3.autoconfig.features.single.servicekind.regular;
...
@SpringBootTest(
    classes= TestApplicationServiceKindSingleAutoConfig.class,
    properties = "dlc.features.servicekinds.packages=io.domainlifecycles.boot3.autoconfig.model.events"
)
@ActiveProfiles({"test", "test-dlc-domain", "test-dlc-persistence"})
@Import(ServiceKindAutoConfigTestConfiguration.class)
public class ServiceKindAutoConfigPackSpecificTest {
    ...
    public void testServiceKindsPresent() {
        assertThat(allServiceKinds).hasSize(5);
    }
