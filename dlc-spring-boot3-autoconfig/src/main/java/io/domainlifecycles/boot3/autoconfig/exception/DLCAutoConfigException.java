...
package io.domainlifecycles.boot3.autoconfig.exception;
...
public class DLCAutoConfigException extends RuntimeException {
     ...
     */
    public static DLCAutoConfigException fail(final String detail) {
        return new DLCAutoConfigException(requireNonNull(detail));
    }
     ...
     * @return new exception
     */
    public static DLCAutoConfigException fail(final String detail, final Throwable cause) {
        return new DLCAutoConfigException(requireNonNull(detail), requireNonNull(cause));
    }
