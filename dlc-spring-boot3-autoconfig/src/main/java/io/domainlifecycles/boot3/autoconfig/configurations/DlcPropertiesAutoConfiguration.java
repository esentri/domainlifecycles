...
/**
 * DlcPropertiesAutoConfiguration is an auto-configuration class that integrates
 * the FeatureProperties configuration into the Spring Boot application context.
 *
 * @author Mario Herb
 */
@AutoConfiguration
