 ...
 * the outbox approach {@link SpringOutboxDomainEventPublisher}.
 *
 * @author Mario Herb
 */
public class DirectSpringTransactionalDomainEventPublisher implements DomainEventPublisher {
    ...
    public void publish(DomainEvent domainEvent) {
        ...
        if (!TransactionSynchronizationManager.isActualTransactionActive() || (passThroughEventTypes != null && passThroughEventTypes.contains(
            ...
            TransactionSynchronizationManager.registerSynchronization(
                new TransactionSynchronization() {
                    ...
                    public void afterCommit() {
                        log.debug(
                            "Publisher transaction committed. Passing DomainEvent {} to ReceivingDomainEventHandler!",
                            domainEvent);
                        receivingDomainEventHandler.handleReceived(domainEvent);
                    }
                }
