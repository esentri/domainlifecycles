## DomainLifeCycles JSON Mapping (Jackson 2, legacy)

> **_NOTE:_** This module provides legacy support for [Jackson 2](https://github.com/FasterXML/jackson).
> All classes are marked `@Deprecated`. For new projects, prefer the
> [Jackson 3 based JSON Mapping](../jackson3-integration/readme.md).
...
`api.io.domainlifecycles.jackson2.JacksonMappingCustomizer`.
...
public class DeactivationMappingCustomizer extends JacksonMappingCustomizer<Deactivation>{
    ...
    @Override
    public void afterObjectRead(DomainObjectMappingContext mappingContext, ObjectCodec codec) {
...
By providing a `io.domainlifecycles.persistence.provider.EntityIdentityProvider` Jackson can tell how new IDs are generated for
Entities
...
the `io.domainlifecycles.jackson2.module.DlcJacksonModule` for this purpose.
