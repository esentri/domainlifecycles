...
package nitrox.dlc.events.receive;
...
import nitrox.dlc.events.receive.execution.processor.ExecutionResult;

import java.util.List;

/**
 * The {@code ReceivingDomainEventHandler} interface defines a contract for classes
 ...
 * {@link #handleReceived(DomainEvent)} method, which takes a domain event and returns a
 * list of execution results.
 *
 * <p><b>Note:</b> It is important to ensure that a non-null domainEvent is provided to the
 * {@link #handleReceived(DomainEvent)} method.
 *
 * @see ExecutionResult
 ...
 * @see DomainEvent
 */
public interface ReceivingDomainEventHandler {
     ...
     */
    List<ExecutionResult> handleReceived(DomainEvent domainEvent);
}
